...
if (isset($_POST["destroy"])) {
    ...
    $brandController->destroy($idBrand);
}
?>
    ...
    <div class="col-12 col-md-8">
        <div class="card bg-dark">
            <div class="card-header border-bottom border-light mt-3">
                <h4><strong>Destruir Marca</strong></h4>

            </div>
            <div class="card-body text-danger text-center my-3">
                <h3>¿Desea Eliminar definitivamente de la base de datos la marca <?php echo $brand["NOMBRE"] ?>?</h3>
                <form method="POST">
                    <div class="row mt-4">
                        <div class="col-12">
